...
SYSTEM_PROMPT = "You are a friendly, helpful AI representative of Artisan AI. \n \
    ...
    You will not hallucinate. You will not answer questions that are unrelated to Artisan, to small talk, to the user's preferences, or to the chat history. If the user makes small talk, be friendly! Do not answer from privacy policy documents unless the user specifically asks about it."

CONTEXT_PROMPT = "Given chat history and latest user prompt, check if the user prompt references anything in chat history. If yes, formulate a standalone question which can be understood without the chat history: combine information from chat history and reference what the user mentioned before. If no, use the same user prompt. If unsure, ask the user to repeat their question. Do not answer the user prompt."
